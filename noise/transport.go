...
// EncryptTransportData seals a packet read from TUN under the given counter.
func EncryptTransportData(sendKey [HashSize]byte, counter uint64, packet []byte) ([]byte, error) {
